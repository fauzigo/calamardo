...
class language
{
	...
	*/
	...
	/**
	 * Verifique que exista el idioma.
	 *
	 * Es un simple chequeo del directorio que deberia tener los archivos de idioma
	 *
	 * @param   string  $lang      idioma a revisar.
	 * @param   string  $basePath  Opcional directorio a revisar.
	 *
	 * @return  boolean  True si existe el idioma.
	 *
	 * @since   11.1
	 */
	public static function exist($lang, $basePath = DIREC_BASE)
	{
		static	$paths	= array();
		...
		require_once(FILESYSTEM.DS.'folder.php');
	 ...
	 * @since   11.1
	 */
	public function load($extension = 'joomla', $basePath = DIREC_BASE, $lang = null, $reload = false, $default = true)
	{
		if (! $lang) {
			$lang = $this->lang;
		}
	...
	{
		$path = self::getLanguagePath(DIREC_BASE, $lang);
		$file = "$lang.xml";
	 ...
	 * @since   11.1
	 */
	public static function getKnownLanguages($basePath = DIREC_BASE)
	{
	 ...
	 * @since   11.1
	 */
	public static function getLanguagePath($basePath = DIREC_BASE, $language = null)
	{
		$dir = "$basePath/languages";
